...
`timescale 1 ps / 1 ps
module basic_mm_interconnect_0 (
	...
	wire  [103:0] performance_counter_control_slave_agent_rf_source_data;                          // performance_counter_control_slave_agent:rf_source_data -> performance_counter_control_slave_agent_rsp_fifo:in_data
	...
	wire  [103:0] performance_counter_control_slave_agent_rsp_fifo_out_data;                       // performance_counter_control_slave_agent_rsp_fifo:out_data -> performance_counter_control_slave_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> performance_counter_control_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                           // performance_counter_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> performance_counter_control_slave_agent:cp_channel
	...
	wire  [102:0] cmd_mux_002_src_data;                                                            // cmd_mux_002:src_data -> nios2_cpu_debug_mem_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                           // nios2_cpu_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> nios2_cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [102:0] performance_counter_control_slave_agent_rp_data;                                 // performance_counter_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [102:0] nios2_cpu_debug_mem_slave_agent_rp_data;                                         // nios2_cpu_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire    [4:0] router_src_channel;                                                              // router:src_channel -> nios2_cpu_data_master_limiter:cmd_sink_channel
	...
	wire    [4:0] nios2_cpu_data_master_limiter_cmd_src_channel;                                   // nios2_cpu_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [4:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> nios2_cpu_data_master_limiter:rsp_sink_channel
	...
	wire    [4:0] nios2_cpu_data_master_limiter_rsp_src_channel;                                   // nios2_cpu_data_master_limiter:rsp_src_channel -> nios2_cpu_data_master_agent:rp_channel
	...
	wire    [4:0] router_001_src_channel;                                                          // router_001:src_channel -> nios2_cpu_instruction_master_limiter:cmd_sink_channel
	...
	wire    [4:0] nios2_cpu_instruction_master_limiter_cmd_src_channel;                            // nios2_cpu_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [4:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> nios2_cpu_instruction_master_limiter:rsp_sink_channel
	...
	wire    [4:0] nios2_cpu_instruction_master_limiter_rsp_src_channel;                            // nios2_cpu_instruction_master_limiter:rsp_src_channel -> nios2_cpu_instruction_master_agent:rp_channel
	...
	wire    [4:0] nios2_cpu_data_master_limiter_cmd_valid_data;                                    // nios2_cpu_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [4:0] nios2_cpu_instruction_master_limiter_cmd_valid_data;                             // nios2_cpu_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	basic_mm_interconnect_0_router router (
	...
	basic_mm_interconnect_0_router_001 router_001 (
	...
	basic_mm_interconnect_0_router_002 router_002 (
	...
	basic_mm_interconnect_0_router_002 router_003 (
	...
	basic_mm_interconnect_0_router_004 router_004 (
	...
	basic_mm_interconnect_0_router_002 router_005 (
	...
	basic_mm_interconnect_0_router_006 router_006 (
	...
	basic_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_c0_clk),                                          //        clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	basic_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_c0_clk),                                                 //        clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	basic_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_c0_clk),                                  //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pll_c0_clk),                                  //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (pll_c0_clk),                                  //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_50MHz_clk_clk),                                     //       clk.clk
		.reset               (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (pll_c0_clk),                                  //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_c0_clk),                                  //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pll_c0_clk),                                  //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (pll_c0_clk),                                  //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_50MHz_clk_clk),                                     //       clk.clk
		.reset              (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (pll_c0_clk),                                   //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	basic_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_c0_clk),                                  //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_c0_clk),                                  //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
